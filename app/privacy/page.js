...
export const metadata = {
  ...
  description: 'NovuliSurvices privacy policy. Learn how we handle, protect and respect your data including Google AdSense advertising, cookie usage, and analytics.',
};
    ...
    <div className="bg-white min-h-screen pt-32 pb-20">
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="space-y-12">
          {[
            ["1. Overview", "NovuliSurvices ('we', 'us', 'our') is committed to protecting your privacy. This Privacy Policy explains what personal information we collect from visitors to novulisurvices.com, how we use that information, with whom we share it, and the choices you have regarding it. By using our website and tools, you consent to the practices described in this policy. If you do not agree with this policy, please discontinue use of our services."],
            ...
            ["8. Your Rights and Choices", "Depending on your jurisdiction, you may have specific rights over your personal data, including requesting a copy, correction, or deletion. Contact us at privacy@novulisurvices.com to exercise these rights."],
            ["9. Children's Privacy", "NovuliSurvices is intended for general audiences and is not directed toward children under the age of 13. We do not knowingly collect personal information from children under 13."],
            ...
            ["11. Contact Us", "If you have any questions, concerns, or requests regarding this Privacy Policy, please contact us: Email: privacy@novulisurvices.com."]
          ].map(([title, content], i) => (
