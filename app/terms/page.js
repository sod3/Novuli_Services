...
export const metadata = {
  title: 'Terms of Service | NovuliSurvices',
  description: 'Read NovuliSurvices terms of service before using our tools.',
};
    ...
    <div className="bg-white min-h-screen pt-32 pb-20">
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="space-y-12">
          {[
            ["1. Acceptance of Terms", "By using NovuliSurvices, you agree to these Terms of Service. If you do not agree, please do not use our services."],
            ["2. Use of Services", "Our tools are provided for lawful, personal or business use. You may not use NovuliSurvices to process illegal content, infringe copyrights, or engage in spam or fraudulent activities."],
            ...
            ["4. Intellectual Property", "NovuliSurvices and its brand assets are our intellectual property. Tools and outputs generated are owned by you. You may use generated content for any lawful purpose."],
            ...
            ["9. Contact", "For terms-related questions, email legal@novulisurvices.com."],
          ].map(([title, content], i) => (
